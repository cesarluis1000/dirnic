<fieldset>
	...
	<?php echo $this->Form->create('Message', array('class' => 'form-horizontal',
		...
		echo $this->Form->input('grado',array('label'=>array('class'=>'control-label col-sm-2')));
		echo $this->Form->input('unidad_policial',array('label'=>array('class'=>'control-label col-sm-2')));
		echo $this->Form->input('cargo',array('label'=>array('class'=>'control-label col-sm-2')));

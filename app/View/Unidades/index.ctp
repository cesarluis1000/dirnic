...
<div class="row">
	<div class="col-md-10">
			<?php echo $this->Form->create('Unidad', array('type' => 'get','url' => 'index','class' => 'form-inline','inputDefaults'=>array('div' => array('class' => 'form-group'),'class'=>'form-control input-xs'))); ?>	
...
<table class="table table-hover table-condensed">
	...
	<tr>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink($this->Html->tag('span', '', array('class' => 'glyphicon glyphicon-trash')), array('action' => 'delete', $unidad['Unidad']['id']),array('class' => 'btn btn-danger btn-xs','escape'=>false), __('Are you sure you want to delete # %s?', $unidad['Unidad']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>

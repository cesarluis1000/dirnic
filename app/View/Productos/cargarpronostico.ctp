<fieldset>
	<legend><?php echo __('Pronostico'); ?></legend>
    	<?php echo $this->Form->create('Cargar', array('class' => 'form-horizontal','type' => 'file',
    		                                          'inputDefaults'=>array('div'      => array('class' => 'form-group'),
                                                		                      ...
                                                		                      'error'     =>  array('attributes' => array('wrap' => 'span', 
                                                		                                                                  'class' => 'help-inline'))))); ?>
    	<?php
    		echo $this->Form->input('pronostico', array('type' => 'file','label'=>array('class'=>'control-label col-sm-2')));
    	?>
    	
    	<div class="form-group">
    		<div class="col-sm-offset-2 col-sm-10">    		
    			<?php $pronostico_src = $this->webroot.'img/'.$pronostico; ?>
				<img src="<?php echo $pronostico_src;?>" width="300">    			
    		</div>
    	</div>
